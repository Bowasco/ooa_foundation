      ...
      <main className="bg-gray-50 min-h-screen py-12 px-6 sm:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-xl p-8">
          ...
          <ul className="list-disc list-inside mb-4 text-gray-700">
            ...
            <li>
              <strong>Excellence:</strong> Ensuring the highest standards in all
              initiatives.
            </li>
            <li>
          ...
          <p className="mb-4 text-gray-700">
            ...
            grand ceremony that further cemented its commitment to education and
            empowerment. At the event, the foundation distributed 250 UTME
            registration forms to deserving candidates, reaffirming its mission
            to provide opportunities for academic advancement.
          </p>
          ...
          <p className="mb-4 text-gray-700">
            ...
            philanthropist passionate about creating equitable opportunities for
            all. His dedication to community service stems from his desire to
            give back to society and uplift those in need.
          </p>
